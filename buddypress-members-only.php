...
Copyright 2015 - 2024  Tomas Zhu  (https://membersonly.top)
...
?>
						<div id="dashboard-widgets-main-content">
							...
							<div class="postbox">
									...
									<span>
									<?php 
											echo  __( '<b>Plugin Address Migration Notice</b>', 'bp-members-only' );
									?>
									</span>
									</h3>
							...
							<div class="inside">
									<ul>
									<li>
										* Buddypress Members Only has been <b>migrated to new WordPress repository address</b>. Please click the <a href='https://wordpress.org/plugins/ssl-for-buddypress' target='_blank'>link</a> to <b>re-install</b> the new version.
									</li>
									<li>
										* You only need to deactivate the current plugin, then install and activate <a href='https://wordpress.org/plugins/ssl-for-buddypress' target='_blank'>Buddypress Members Only New</a>. All data and settings will be automatically saved and migrated, <b>with no risk involved</b>.
									</li>									
							...
							<div class="inside">
								...
								* <a class=""  target="_blank" href="https://tomas.zhu.bz/category/my-share/">Sign UP for Free BuddyPress / WordPress Tips MailChimp List</a>
								...
								<div class="postbox">
									...
									<div class="inside" style='padding-left:10px;'>
						<?php 
							wp_widget_rss_output('https://membersonly.top/feed/', array(
							'items' => 3, 
							'show_summary' => 0, 
							'show_author' => 0, 
							'show_date' => 1)
...
function members_only_free_hide_notices()
{
    if (isset($_GET['members-only-free-hide-notice']) && isset($_GET['members_only_free_notice_nonce'])) {
        if (! wp_verify_nonce($_GET['members_only_free_notice_nonce'], 'members_only_free_hide_notices_nonce')) {
            wp_die(__('Action failed. Please refresh the page and retry.', 'members_only_free'));
        }

        if (! current_user_can('manage_options')) {
            wp_die(__('Cheatin&#8217; huh?', 'members_only_free'));
        }

        $hide_notice = sanitize_text_field($_GET['members-only-free-hide-notice']);
        update_option('members_only_free_have_new_version_' . $_GET['members-only-free-hide-notice'], 'dismiss');
    }
}
...
function members_only_free_only_update_notify($p_message, $version)
{
    ...
    ?>
<a class="notice-dismiss members-only-free-update-dismiss"
	href="<?php echo esc_url( wp_nonce_url( add_query_arg( 'members-only-free-hide-notice', $version ), 'members_only_free_hide_notices_nonce', 'members_only_free_notice_nonce' ) ); ?>"><?php echo __( 'Dismiss', 'bp-members-only' ); ?></a>
<?php
    echo '<p>';
    echo $p_message;
    echo '</p>';
